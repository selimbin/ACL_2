...
export class ViewAcceptedRequests extends Component{
    state = {
        id:'',
        Requests:[axios]
    }
    ...
    axios.post("http://localhost:5000/staff/viewAcceptedRequests", Requests ,{
            headers:
            {
        ...
        .then(res =>this.setState({ViewAcceptedRequests:res.data}))
