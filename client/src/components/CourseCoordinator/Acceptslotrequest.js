...
export class Acceptslotrequest extends Component {
    ...
    mySubmitHandler = event => {
        ...
        axios.put("http://localhost:5000/staff/acceptslotlinkingreq", request,{
            headers:
            {
        ...
        .then((res) => toast.success("Request accepted successfully",{position: toast.POSITION.TOP_CENTER}))
