...
export class AssignStaffCourse extends Component {
    ...
    mySubmitHandler = event => {
        ...
        axios.post("http://localhost:5000/staff/assignInstructor", course,{
            headers:
            {
        ...
        .then((res) => toast.success("Instructor assigned successfully",{position: toast.POSITION.TOP_CENTER}))
            ...
            <div class="ManageDepartment">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="id" name="id" placeholder="Enter Instructor to Assign to this course.." onChange={this.myChangeHandler}></input>
                        </div>
                    </div> 
                    <div class="row">
