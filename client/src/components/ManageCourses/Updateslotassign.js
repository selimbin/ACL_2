...
let x = 0;
let array = [];
export class Updateslotassign extends Component {
    state = {
        slot_no: 0,
        day:'',
        staff_id : '',
    ...
    mySubmitHandler = event => {
        ...
        const slot = {
            ...
            newstaff_id :this.state.newstaff_id,
            courses : array
        };

        axios.put("http://localhost:5000/staff/UpdateAssignslots", slot,{
            headers:
            {
        ...
        .then((res) => toast.success("slot assignment updated successfully",{position: toast.POSITION.TOP_CENTER}))
            ...
            <div class="container">
                ...
                <ToastContainer />
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-25">
                            <label htmlfor="newstaff_id">newstaff id</label>
                        </div>
                        <div class="col-75">
                            <input type="text" id="newstaff_id" name="newstaff_id" placeholder="Enter the course code.." onChange={this.myChangeHandler}></input>
                        </div>
                    </div>
...
export default Updateslotassign