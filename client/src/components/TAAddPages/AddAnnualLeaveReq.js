...
export class AddAnnualLeaveReq extends Component {
    state = {
        id: '',
        Replacement:'',
        reason:'',
            ...
            <div class="AddPage">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="Replacement" name="Replacement" placeholder="Enter your replacment id .." onChange={this.myChangeHandler}></input>
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-25">
...
export default AddAnnualLeaveReq